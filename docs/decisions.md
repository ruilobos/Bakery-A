...
| [038](#adr-038-agent-assisted-task-loop) | Agent-assisted task loop | Accepted (amended by 039) | `/next-task` executes one task and stops at the open PR |
...
- **2026-08-29 · Accepted** — the 1.7 clause in Traps amended by [039](#adr-039-rename-only-the-identifiers-epic-3-leaves-behind)
...
## ADR-040: &lt;next decision goes here&gt;
