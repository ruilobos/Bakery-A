...
| [038](#adr-038-agent-assisted-task-loop) | Agent-assisted task loop | Accepted | `/next-task` executes one task and stops at the open PR |
...
## ADR-039: &lt;next decision goes here&gt;
